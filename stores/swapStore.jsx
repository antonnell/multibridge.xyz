...
class Store {
  ...
  getSwapTokens = async (payload) => {
    try {
      const swapTokensResult = await fetch(`https://gist.githubusercontent.com/andrecronje/94757cd2b1bd054eb3992226859a7562/raw/596f8642bfb971e2f844a089181eaf4492c114a9/anyswap`)
